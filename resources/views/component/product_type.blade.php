                            ...
                            <div class="col-sm-4">															
                                <div class="single-item">															
                                    <div class="single-item-header">															
                                        <a href="../details/{{$sp->id}}"><img width="200" height="200" src="/source/image/product/{{$sp->image}}" alt=""></a>															
                                    </div>															
                                    ...
                                    <div class="single-item-caption">						
                                        <a class="add-to-cart pull-left" href="../addCart"><i class="fa fa-shopping-cart"></i></a>															
                                        <a class="add-to-cart pull-left" href="../addCart"><i class="fa fa-heart"></i></a>															
                                        <a class="beta-btn primary" href="../details/{{$sp->id}}">Details <i class="fa fa-chevron-right"></i></a>															
                                        <div class="clearfix"></div>															
                                    </div>															
                                </div>															
                            </div>															
                        ...
                        <div class="row">															
                            ...
                            <div class="col-sm-3">															
                                <div class="single-item">															
                                    ...
                                    <div class="single-item-caption">															
                                        <a class="add-to-cart pull-left" href="../addCart"><i class="fa fa-shopping-cart"></i></a>															
                                        <a class="beta-btn primary" href="../details/{{$khac->id}}">Details <i class="fa fa-chevron-right"></i></a>															
                                        <div class="clearfix"></div>															
                                    </div>															
                                </div>															
                            </div>															
